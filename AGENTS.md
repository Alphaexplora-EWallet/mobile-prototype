...
The active project for this task is **E-Wallet**.

Project resources (also written to `.multica/project/resources.json`):

- **local_directory**: `{"label":"wallet","daemon_id":"019fd21e-f2b8-70b3-bd7a-e69d5a056a55","local_path":"C:\\Users\\Personal\\Desktop\\wallet"}`

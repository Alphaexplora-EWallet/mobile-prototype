...
| `security.mock.ts`      | `MOCK_TRANSACTION_PIN` `"246810"`, `MOCK_OTP_CODE` `"135790"`, `MOCK_OTP_DESTINATION` `"0917 ••• 2288"`, `MOCK_SESSIONS` (2)                                                                                                                                                                                                                         | Fixed credentials on purpose — a prototype nobody can get into is not a prototype. Both are shown as hints on the screens that ask                                                                                                                     |
